...
class ContactSide extends React.Component {
    ...
    state = {
        ...
        message: '',
        ContactItems: [
            {id: 1, title: 'E-mail', body: 'shreecs03@gmail.com'},
            {id: 2, title: 'Address', body: '1 RADHA KRISHNA NAGAR, S N DUBE RD DAHISAR E, NR SHANI MANDIR MUMBAI, MH 400068 IN'},
            {id: 3, title: 'Phone', body: '+91-8850091791'},
