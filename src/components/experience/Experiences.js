...
class Experiences extends React.Component{
    ...
    state = {
        experiences: [
            {id: 1, type: 'work', time: '2019 - Present', field: 'FullStack Web Developer', location: 'Mumbai', description: 'Collaborate with creative and development teams on the execution of ideas.'},
            ...
            {id: 3, type: 'education', time: '2013 - 2016', field: 'bachelor degree Computer', location: 'MIT', description: 'Collaborate with creative and development teams on the execution of ideas.'},
        ]
    }
